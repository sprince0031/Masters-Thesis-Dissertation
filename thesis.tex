...
% here is how to add a figure in the appendix�. it is the same as any other place in the latex document
\figuremacroW{7_appendixes/image01}{Title of Figure}{Description. [Source: (\Citealt{mydownloadedimage})]}{0.8}
